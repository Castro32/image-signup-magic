...
// export default ComingSoon;
import { useState } from "react";
import W5 from "../assets/g.jpg";

const ComingSoon = () => {
  const googleFormUrl =
    "https://res.cloudinary.com/dnacduwvj/image/upload/v1768289101/Lodo_ertiy5.png";
  ...
  return (
    <main className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen w-full items-end justify-center px-6 sm:px-10 bg-black/40 pb-8 sm:pb-12 md:pb-16 lg:pb-20">
        <div className="space-y-4 w-full max-w-3xl text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#FFFFFF] uppercase leading-tight tracking-wide">
            BE PART OF THE NEXT BIG RETAIL EXPERIENCE COMING SOON IN <br/> <span>Lavington, Nairobi Kenya</span>.
          </h1>
          <p className="text-[#E7E0D0] text-lg sm:text-lg md:text-xl leading-relaxed mt-2 font-medium">
            Tenants interested in occupying space, please send us your inquiry.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-3 mt-8">
            <a
